...
public interface StockPriceRepository extends JpaRepository<StockPrice, Long> {
    ...
    List<StockPrice> findByStockAndPriceDateAfterAndDataSourceInOrderByPriceDateAsc(
            Stock stock, LocalDate after, Collection<String> dataSources);
    ...
    Optional<StockPrice> findByStockAndPriceDate(Stock stock, LocalDate date);
}
